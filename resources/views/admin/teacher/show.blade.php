                    ...
                    <div class="bg-white shadow mt-24">
                        <div class="flex flex-col md:flex-row items-center gap-4">
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    @if($teacher->profile_image)
                                        <img src="{{$teacher->profile_image}}" alt="{{$teacher->family}}">
                                    @else
                            ...
                            <div class="mt-20 text-right border-b w-full pb-12"><h1
                                    ...
                                    {{$teacher->name ." ".$teacher->family}} </h1>
                                <p class="font-light text-gray-600 mt-3">کد ملی : {{$teacher->personal_code}}</p>
                                <p class="mt-3 text-gray-500">تلفن همراه:{{$teacher->phone}}</p>
                            </div>
                        ...
                        <div class="mt-12 flex flex-col justify-center">
                            ...
                            <p class="text-gray-600 text-center font-light lg:px-16">
                                <span>آدرس:</span> {{$teacher->address}}
                            </p>
                        </div>
                    </div>
                </div>
