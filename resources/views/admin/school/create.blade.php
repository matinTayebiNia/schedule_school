...
"
                        ...
                        <div class="my-3 flex gap-3">
                            <x-button-primary-dashboard targetLoading="save" textButton="ثبت" icon=' <svg aria-hidden="true" wire:loading wire:target="save" role="status"
        ...
        <path
            ...
            fill="currentColor"/>
                            ...
                            <x-button-cancel-dashboard :route="route('admin.school.index')"/>
                        </div>
                    </form>
                </div>
            </div>
