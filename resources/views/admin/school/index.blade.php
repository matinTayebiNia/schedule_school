                ...
                <div class="inline-bloc bg-white min-w-full shadow rounded-lg overflow-hidden">
                    ...
                    <table class="min-w-full leading-normal">
                            ...
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <div class="flex gap-2 items-center justify-center">
                                        ...
                                        @can("delete-school")
                                            <button type="button"
                                                    x-on:click="[showModal=true, target_id='{{$school->id}}']"
                                            >
                                                <svg
                                        ...
                                        @endcan
                                        @can("see-classes")
                                                <a href="{{route("admin.class.index",$school->id)}}" class=" px-4 py-2 text-base
                     font-semibold text-white bg-purple-600 rounded-lg
                      ...
                      focus:ring-offset-purple-200">نمایش کلاس ها </a>
                                        @endcan
                    ...
                    {{$schools->appends(['search'=>request('search')])->links('layouts.paginate')}}
                </div>
            </div>
        </div>
    @endcan
        ...
        <div class="overflow-auto" style="background-color: rgba(0,0,0,0.5)" x-show="showModal"
            ...
            <div class="bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg py-4 text-left px-6"
                ...
                <div x-show="showModal" class="flex justify-between items-center pb-3">
                    <p class="text-2xl font-bold">حذف مدرسه!</p>
                ...
                <form action="{{route("admin.school.destroy")}}" method="post" class="my-2">
                    @method("DELETE")
                    @csrf
                    <input type="hidden" name="school_id" :value="$data.target_id">


                    <!-- content -->

                    <p>ایا از حذف مدرسه مورد نظر مطمئن هستید</p>
