                ...
                <div class="inline-bloc bg-white min-w-full shadow rounded-lg overflow-hidden">
                    ...
                    <div class="p-6 mt-8">
                        <div class="w-full rounded-lg block">
                            <form wire:submit.prevent="update('{{$student_id}}')" class=" w-full ">
                                <div class="relative">
...
"
                     ...
                     font-semibold text-white bg-purple-600 rounded-r-lg
                      ...
                      focus:ring-offset-purple-200 ">
                                ...
                                <div class="my-3 flex gap-3">
                                    <x-button-primary-dashboard textButton=" ویرایش " targetLoading="update('{{$student_id}}')"
                                                                icon=' <svg aria-hidden="true" wire:loading wire:target="update" role="status"
        ...
        <path
            ...
            fill="currentColor"/>
                                    ...
                                    <x-button-cancel-dashboard :route="route('admin.student.index')"/>
                                </div>
                            </form>
                        </div>
                    </div>
