        ...
        <div class="inline-bloc bg-white min-w-full shadow rounded-lg overflow-hidden">
            ...
            <div class="p-6 mt-8">
                <div class="w-full rounded-lg block">
                    <form action="{{route("admin.profile.update")}}" method="post" class=" w-full ">
                        @csrf
                        @method("PATCH")
                        <div class="relative">
                     ...
                     font-semibold text-white bg-purple-600 rounded-r-lg
                      ...
                      focus:ring-offset-purple-200 ">
                        ...
                        <div class="my-3 flex gap-3">
                            ...
                            <x-button-cancel-dashboard :route="route('admin.dashboard')"></x-button-cancel-dashboard>
                        </div>
                    </form>
                </div>
            </div>
            <div class="p-6 mt-8">
                <div class="w-full rounded-lg block">
                    <form action="{{route("admin.password.update")}}" method="post" class=" w-full ">
                        @csrf
                        @method("PUT")
                        <div class="relative">
