    ...
    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
        <div class="inline-bloc bg-white min-w-full shadow rounded-lg overflow-hidden">
            ...
            <div class="p-6 mt-8">
                <div class="w-full rounded-lg block">
                    <form wire:submit.prevent="update('{{$lessen_id}}')" class=" w-full ">
                        <div class="relative">
                        ...
                        <div class="my-3 flex gap-3">
                            <x-button-primary-dashboard targetLoading="update('{{$lessen_id}}')" textButton="وبرایش"
        ...
        <path
            ...
            fill="currentColor"/>
                            ...
                            <x-button-cancel-dashboard :route="route('admin.lessen.index')"/>
                        </div>
                    </form>
                </div>
            </div>
