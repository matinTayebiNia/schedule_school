        ...
        <div
            ...
            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                ...
                <div class="inline-bloc bg-white min-w-full shadow rounded-lg overflow-hidden">
                            ...
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <div class="flex gap-2">
                                        ...
                                        @can("delete-role")
                                            <button type="button"
                                                    x-on:click="[showModal=true, target_id='{{$role->id}}']"
                                            >
                                                <svg
                    ...
                    {{$roles->appends(['search'=>request('search')])->links('layouts.paginate')}}
                </div>
            </div>
        </div>
    @endcan
        ...
        <div class="overflow-auto" style="background-color: rgba(0,0,0,0.5)" x-show="showModal"
            ...
            <div class="bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg py-4 text-left px-6"
                ...
                <div x-show="showModal" class="flex justify-between items-center pb-3">
                    <p class="text-2xl font-bold">حذف مقام!</p>
                ...
                <form action="{{route("admin.roles.destroy",rand(11,99))}}" method="post" class="my-2">
                    @method("DELETE")
                    @csrf
                    <input type="hidden" name="role_id" :value="$data.target_id">


                    <!-- content -->

                    <p>ایا از حذف مقام مورد نظر مطمئن هستید</p>
