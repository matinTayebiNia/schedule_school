                ...
                <div class="w-full rounded-lg block">
                    <form action="{{route("admin.roles.store")}}" method="post">
                        ...
                        <div class="relative">
                            ...
                            <x-input-dashboard livewireModel="name" name="name" placeholder="نام مقام را وارد کنید">
                            </x-input-dashboard>
                        ...
                        <div class="relative">
                            ...
                            <x-input-dashboard livewireModel="label" name="label" placeholder="توضیحات را وارد کنید">
                            </x-input-dashboard>
