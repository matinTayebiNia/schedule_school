                            ...
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <div class="flex gap-2 items-center ">
                                        ...
                                        @can("delete-user")
                                            <button type="button"
                                                    x-on:click="[showModal=true, target_id='{{$user->id}}']"
                                            >
                                                <svg
    ...
    <!--Overlay-->
        <div class="overflow-auto" style="background-color: rgba(0,0,0,0.5)" x-show="showModal"
            ...
            <div class="bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg py-4 text-left px-6"
                ...
                <form action="{{route("admin.users.destroy")}}" method="post" class="my-2">
                    @method("DELETE")
                    @csrf
                    ...
                    <p>ایا از حذف ادمین مورد نظر مطمئن هستید</p>
