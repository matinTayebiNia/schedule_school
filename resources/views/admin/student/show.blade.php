                    ...
                    <div class="bg-white shadow mt-24">
                        <div class="flex flex-col md:flex-row items-center gap-4">
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    @if($student->profile_image)
                                        <img src="{{$student->profile_image}}" alt="{{$student->family}}">
                                    @else
                            ...
                            <div class="mt-20 text-right border-b w-full pb-12"><h1
                                    ...
                                    {{$student->name ." ".$student->family}} </h1>
                                <p class="font-light text-gray-600 mt-3">کد ملی : {{$student->personal_code}}</p>
                            </div>
                        ...
                        <div class="mt-12 flex flex-col justify-center">
                            ...
                            <p class="text-gray-600 text-center font-light lg:px-16">
                                <span>آدرس:</span> {{$student->address}}
                            </p>
                        </div>
                    </div>
                </div>
